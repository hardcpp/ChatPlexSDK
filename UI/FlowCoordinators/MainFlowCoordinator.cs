namespace CP_SDK.UI.FlowCoordinators
{
    ...
    {
        public override string Title => $"{(!string.IsNullOrEmpty(m_TitleOverride) ? m_TitleOverride : ChatPlexSDK.ProductName)} V{ChatPlexSDK.ProductVersion}";

        ////////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////////

        private static string m_TitleOverride = null;
        ...
        /// Override the title
        /// </summary>
        /// <param name="p_Override">New override</param>
        internal static void OverrideTitle(string p_Override)
        {
