...
namespace CP_SDK.UI.Components
{
    ...
    public abstract class CFloatingPanel : IScreen
    {
        ...
        private Dictionary<EGenericScene, (Vector3, Vector3)>       m_SceneTransforms       = new Dictionary<EGenericScene, (Vector3, Vector3)>();
        private Dictionary<EGenericScene, Action<Vector3, Vector3>> m_OnSceneRelease        = new Dictionary<EGenericScene, Action<Vector3, Vector3>>();
        ...
        /// </summary>
        /// <returns></returns>
        public bool GetAllowMovement() => m_AllowMovement;
        ...
        /// <returns></returns>
        public CFloatingPanel SetAlignWithFloor(bool p_Align)
        {
        ...
        /// <returns></returns>
        public CFloatingPanel SetBackground(bool p_Enabled, Color? p_Color = null)
        {
            if (p_Enabled)
            {
                if (!m_Background)
        ...
        /// <returns></returns>
        public CFloatingPanel SetBackgroundColor(Color p_Color)
        {
            if (!m_Background)
                return this;
        ...
        /// <returns></returns>
        public CFloatingPanel SetBackgroundSprite(Sprite p_Sprite, Image.Type p_Type = Image.Type.Simple)
        {
            if (!m_Background)
                return this;
        ...
        /// <returns></returns>
        public CFloatingPanel SetLockIcon(ECorner p_Corner)
        {
        ...
        /// <param name="p_Corner">Corner or none</param>
        /// <returns></returns>
        public CFloatingPanel SetGearIcon(ECorner p_Corner)
        {
            if (p_Corner == ECorner.None)
            {
                if (m_GearIcon)
        ...
        /// <returns></returns>
        public CFloatingPanel OnSceneRelease(EGenericScene p_Scene, Action<Vector3, Vector3> p_Callback)
        {
        ...
        /// <returns></returns>
        public CFloatingPanel SetSceneTransform(EGenericScene p_Scene, Vector3 p_LocalPosition, Vector3 p_LocalEulerAngles)
        {
            ...
            if (p_Scene == ChatPlexSDK.ActiveGenericScene)
            {
                ...
                {
                    ChatPlexSDK.Logger.Error($"[CP_SDK.UI.Components][CFloatingPanel.SetSceneTransform] Error:");
                    ChatPlexSDK.Logger.Error(l_Exception);
                }
            }
        ...
        public virtual CFloatingPanel SetSize(Vector2 p_Size)
        {
            ...
            {
                ChatPlexSDK.Logger.Error($"[CP_SDK.UI.Components][CFloatingPanel.SetSize] Error:");
                ChatPlexSDK.Logger.Error(l_Exception);
            }
        ...
        /// <param name="p_LocalEulerAngles">Local euler angles</param>
        /// <returns></returns>
        public CFloatingPanel SetTransformDirect(Vector3 p_LocalPosition, Vector3 p_LocalEulerAngles)
        {
            RTransform.localPosition    = p_LocalPosition;
            RTransform.localEulerAngles = p_LocalEulerAngles;
            ...
            {
                ChatPlexSDK.Logger.Error($"[CP_SDK.UI.Components][CFloatingPanel.SetTransformDirect] Error:");
                ChatPlexSDK.Logger.Error(l_Exception);
            }
        ...
        protected virtual void Awake()
        {
            ...
            OnRelease((_) =>
            {
                ...
                if (m_OnSceneRelease.TryGetValue(ChatPlexSDK.ActiveGenericScene, out var l_OnSceneReleaseCallback) && l_OnSceneReleaseCallback != null)
                {
                    ...
                    {
                        ChatPlexSDK.Logger.Error($"[CP_SDK.UI.Components][CFloatingPanel.OnRelease] Error:");
                        ChatPlexSDK.Logger.Error(l_Exception);
                    }
                }
            });
        ...
        private void ChatPlexSDK_OnGenericSceneChange(EGenericScene p_ActiveScene)
        {
            ...
            if (m_SceneTransforms.TryGetValue(p_ActiveScene, out var l_SceneTransform))
            {
                ...
                {
                    ChatPlexSDK.Logger.Error($"[CP_SDK.UI.Components][CFloatingPanel.ChatPlexSDK_OnGenericSceneChange] Error:");
                    ChatPlexSDK.Logger.Error(l_Exception);
                }
            }
        }
