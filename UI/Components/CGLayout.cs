...
namespace CP_SDK.UI.Components
{
    ...
    public abstract class CGLayout : MonoBehaviour
    {
        ...
        /// <returns></returns>
        public CGLayout SetWidth(float p_Width)
        {
        ...
        /// <returns></returns>
        public CGLayout SetHeight(float p_Height)
        {
        ...
        /// <param name="p_Width">Width</param>
        /// <returns></returns>
        public CGLayout SetMinWidth(float p_Width)
        {
        ...
        /// <param name="p_Height">Height</param>
        /// <returns></returns>
        public CGLayout SetMinHeight(float p_Height)
        {
        ...
        /// <returns></returns>
        public CGLayout SetCellSize(Vector2 p_CellSize)
        {
        ...
        /// <returns></returns>
        public CGLayout SetChildAlign(TextAnchor p_ChildAlign)
        {
        ...
        /// <returns></returns>
        public CGLayout SetConstraint(GridLayoutGroup.Constraint p_Constraint)
        {
        ...
        /// <returns></returns>
        public CGLayout SetConstraintCount(int p_ConstraintCount)
        {
        ...
        /// <returns></returns>
        public CGLayout SetSpacing(Vector2 p_Spacing)
        {
