...
namespace CP_SDK.UI.Components
{
    ...
    public abstract class CText : MonoBehaviour
    {
        ...
        {
            TMProProxy.TMP_Text_SetAlignment(TMProUGUI, p_Align);
            return this;
        }
        /// <summary>
        /// Set alpha
        ...
        {
            TMProProxy.TMP_Text_SetTextOverflowMode(TMProUGUI, p_OverflowMode);
            return this;
        }
        /// <summary>
        /// Set style
        ...
        {
            TMProProxy.TMP_Text_SetFontStyle(TMProUGUI, p_Style);
            return this;
        }
        /// <summary>
        /// Set button text
