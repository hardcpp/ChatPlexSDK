...
namespace CP_SDK.UI.DefaultComponents
{
    ...
    public class DefaultCVVList : Components.CVVList
    {
        ...
        public virtual void Init()
        {
            ...
            GameObject.DestroyImmediate(m_ScrollView.Container.parent.GetComponent<ContentSizeFitter>());
        ...
        /// Clear
        /// </summary>
        /// <param name="p_ScrollToTop">Should scroll back to top after clearing?</param>
