...
namespace CP_SDK.UI.DefaultComponents
{
    ...
    public class DefaultCTabControl : Components.CTabControl
    {
        ...
        public override Components.CTabControl SetTabs(params (string, RectTransform)[] p_Tabs)
        {
            ...
            {
                var l_Tab = p_Tabs[l_I].Item2;
                l_Tab.gameObject.SetActive(false);
                l_Tab.SetParent(m_Content.RTransform, false);
                l_Tab.localPosition     = Vector3.zero;
                l_Tab.localScale        = Vector3.one;
                l_Tab.localEulerAngles  = Vector3.zero;
                l_Tab.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Bottom, 0, 0);
                l_Tab.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Top,    0, 0);
                l_Tab.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Left,   0, 0);
                l_Tab.SetInsetAndSizeFromParentEdge(RectTransform.Edge.Right,  0, 0);
                l_Tab.anchorMin         = Vector2.zero;
                l_Tab.anchorMax         = Vector2.one;
            }
        ...
        /// </summary>
        /// <param name="p_Index">Index of the text</param>
