...
namespace CP_SDK.UI.DefaultComponents
{
    ...
    internal class DefaultCFloatingPanel : Components.CFloatingPanel
    {
        ...
        private event   Action<Components.CFloatingPanel>   m_OnReleaseEvent;
        private event   Action<Components.CFloatingPanel>   m_OnGrabEvent;
        ...
        {
            try { m_OnReleaseEvent?.Invoke(this); }
            catch (System.Exception l_Exception)
            {
