...
namespace CP_SDK.UI
{
    ...
    public static class UISystem
    {
        ...
        public static Color DefaultBGColor          = ColorU.WithAlpha("#000000", 0.5000f);
        public static Color NavigationBarBGColor    = ColorU.WithAlpha("#727272", 0.6500f);
        public static Color PrimaryColor            = ColorU.WithAlpha("#258CFF", 1.0000f);
        public static Color SecondaryColor          = ColorU.WithAlpha("#858587", 1.0000f);
        public static Color TitleBlockBGColor       = ColorU.WithAlpha("#727272", 0.5000f);
        public static Color ModalBGColor            = ColorU.WithAlpha("#202021", 0.9750f);
        public static Color ListBGColor             = ColorU.WithAlpha("#000000", 0.7500f);
        public static Color KeyboardTextBGColor     = ColorU.WithAlpha("#7F7F7F", 0.5000f);
        ...
        internal static void Init()
        {
            ...
            if (CPConfig.Instance.EventSpecials && DateTime.Now.Month == 10)
            {
                ...
                TextColorDisabled   = TextColor * 0.75f;
            }
        ...
        private static Sprite GetXSprite(ref Sprite p_Sprite, string p_File, Vector4 p_Borders)
        {
            ...
            p_Sprite = Unity.SpriteU.CreateFromTexture(l_Texture, 100.0f, new Vector2(0.5f, 0.5f), 0, SpriteMeshType.FullRect, p_Borders);
